...
function generateMockAIResponse(prompt: string) {
  ...
  if (lowerPrompt.includes('bakery') || lowerPrompt.includes('bread') || lowerPrompt.includes('cake')) {
    businessType = 'Bakery'
    features = [
      { id: 'dashboard', name: 'Dashboard', description: 'Track daily sales and revenue' },
      { id: 'inventory', name: 'Inventory', description: 'Manage ingredients and finished products' },
      { id: 'product', name: 'Product', description: 'Manage bread, cakes, and pastry items' },
      { id: 'customer', name: 'Customer', description: 'Track customer orders and preferences' },
      { id: 'reports', name: 'Reports', description: 'Sales reports and profit analysis' }
    ]
    ...
    features = [
      { id: 'dashboard', name: 'Dashboard', description: 'Track orders and daily revenue' },
      { id: 'inventory', name: 'Inventory', description: 'Manage food ingredients and supplies' },
      { id: 'product', name: 'Product', description: 'Manage menu items and pricing' },
      { id: 'staff', name: 'Staff', description: 'Manage employees and shifts' },
      { id: 'customer', name: 'Customer', description: 'Track customer orders and feedback' },
      { id: 'reports', name: 'Reports', description: 'Sales and profitability reports' }
    ]
    ...
    features = [
      { id: 'dashboard', name: 'Dashboard', description: 'Track sales transactions' },
      { id: 'inventory', name: 'Inventory', description: 'Manage stock levels and products' },
      { id: 'product', name: 'Product', description: 'Manage product catalog' },
      { id: 'customer', name: 'Customer', description: 'Track customer purchases' },
      { id: 'credit', name: 'Credit', description: 'Manage customer credit accounts' },
      { id: 'reports', name: 'Reports', description: 'Sales and inventory reports' }
    ]
    ...
    features = [
      ...
      { id: 'inventory', name: 'Inventory', description: 'Manage stock and products' },
      { id: 'product', name: 'Product', description: 'Manage product catalog' },
